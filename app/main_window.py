...
Home -> Crear sala / Unirse a sala -> Llamada, sin abrir ventanas
adicionales ni requerir configuración de red por parte del usuario común.
"""
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        for w in (self.home_screen, self.create_room_screen, self.join_room_screen, self.call_screen):
